...
def predict():
    if request.method == 'POST':
        ...
        if prediction==1:
             return render_template('index.html',prediction_text="Oh No! The customer will leave the bank!")
        else:
             return render_template('index.html',prediction_text="Great! The customer will not leave the bank.")
